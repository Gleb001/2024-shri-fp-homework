...
/**
 * Repeatedly calls an API until a successful result is achieved or the maximum number of steps is reached.
 *
 * @param {function} api - The API function to be called. It should return a promise that resolves to an object containing a 'result' property.
 * @param {number} steps - The maximum number of attempts to call the API.
 * @returns {function} - A function that takes data as a parameter and returns the API response if successful, or an object with a null result if all attempts fail.
 */
